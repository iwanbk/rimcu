...
func (sc *StringsCache) runSubscriber(ctx context.Context) error {
...
func (sc *StringsCache) startSub() (chan struct{}, error) {
...
func (sc *StringsCache) handleNotif(data []byte) error {
	// decode notification
